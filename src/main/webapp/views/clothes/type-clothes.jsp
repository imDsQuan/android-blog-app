...
<body>
    <div class="container">
	 ...
	 <div class="small-view">
        ...
        <div class="row row-2">
            <h2>${category}</h2>
            <form action="${pageContext.request.contextPath}/clothes/typeclothes?type=${typeClothes}" method="post">
        ...
        <div class="row">
			<c:forEach var="clothes" items="${clothesList}">
            	<div class="col-4">
	                ...
	                <a  href="${pageContext.request.contextPath}/clothes-detail?id=${clothes.id}"> <h4><c:out value="${clothes.name}"/></h4></a>
        ...
        <div class="page-btn">
            ...
            <c:forEach begin="1" end="${totalPage}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <span><a href="clothes/typeclothes?type=${typeClothes}&page=${i}">${i}</a></span>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
